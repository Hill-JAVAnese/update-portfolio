...
const projects = [
  {
    ...
    desc: 'A relaxing farming simulator built with Unity and C#.',
    img: 'https://via.placeholder.com/300x200',
  },
  {
    title: 'Retro Platformer',
    desc: 'Classic pixel-art platformer made with Godot.',
    img: 'https://via.placeholder.com/300x200',
  },
  {
    title: 'Portfolio Website',
    desc: 'Built this portfolio using React, Tailwind CSS, and Framer Motion.',
    img: 'https://via.placeholder.com/300x200',
  },
];
